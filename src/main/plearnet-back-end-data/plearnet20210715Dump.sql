...
--
-- Host: 127.0.0.1    Database: plearnet
-- ------------------------------------------------------
...
CREATE TABLE `collect` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `DA` FOREIGN KEY (`user_id`) REFERENCES `useraccount` (`id`)
...
CREATE TABLE `history` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `` FOREIGN KEY (`user_id`) REFERENCES `useraccount` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  KEY `index2` (`topic_id`),
  CONSTRAINT `D` FOREIGN KEY (`topic_id`) REFERENCES `topic` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `topic` (
  ...
  CONSTRAINT `AUTHOR` FOREIGN KEY (`author`) REFERENCES `useraccount` (`id`),
...
CREATE TABLE `useraccount` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='使用者帳戶';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `useraccount` VALUES ('10746010','10746010','10746010@ntub.edu.tw',1,'',0,'0000-00-00 00:00:00'),('10746016','10746016','10746016@ntub.edu.tw',2,'',0,'0000-00-00 00:00:00'),('10746022','10746022','10746022@ntub.edu.tw',3,'',0,'0000-00-00 00:00:00'),('10746041','10746041','10746041@ntub.edu.tw',4,'',0,'0000-00-00 00:00:00'),('n1076417','n1076417','n1076417@ntub.edu.tw',5,'',0,'0000-00-00 00:00:00');
...
-- Dump completed on 2021-07-15 16:08:35
